...
func TestPeriodicNext(t *testing.T) {
	tests := []struct {
		...
		// Round to 1 second if the duration is less
		{
			...
			want:   "Mon Jun 6 17:38:01.059 2016",
		},

		// Round to nearest second when calculating the next time.
		{"Mon Jun 6 17:38:01.009 2016", 15 * time.Minute, "Mon Jun 6 17:53:01.009 2016"},

		// Round to nearest second for both
		{"Mon Jun 6 17:38:01.009 2016", 15*time.Minute + 50*time.Nanosecond, "Mon Jun 6 17:53:01.009 2016"},
	}
